...
class Vgg16():
    ...
    def ft(self, num):
        ...
        model = self.model
        model.pop()  # 1000
        model.pop()  # fc1 dropout
        fc1w = model.layers[-1].get_weights()
        model.pop()  # fc1 dense
        model.pop()  # fc2 dropout
        ...
        model.layers[-3].set_weights(fc1w)
    ...
    def compile(self, lr=0.001):
        ...
        """
        self.model.compile(optimizer=SGD(lr=lr, nesterov=True, momentum=0.9),
