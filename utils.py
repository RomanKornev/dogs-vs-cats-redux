...
#TODO: activity_l2, activity_l1 : https://github.com/fchollet/keras/commit/1c630c3e3c8969b40a47d07b9f2edda50ec69720
...
#TODO: layer_from_config -> layers.deserialize : https://github.com/fchollet/keras/commit/ebe84eb3a1c3beb44e25fa4f00a89f2c71dde2cc
...
def get_data(path, target_size=(224,224), fraction=1):
    batches = get_batches(path, shuffle=False, batch_size=1, class_mode=None, target_size=target_size)
    return np.concatenate([batches.next() for i in range(int(batches.samples*fraction))])
